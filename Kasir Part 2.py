...
print(Back.WHITE + Fore.BLACK + "----------------- Program Kasir Sederhana Ekorkode -----------------")
pembeli = input("Masukkan nama Pembeli: ")
print (Fore.GREEN + "Nama Pembeli: " + pembeli)
...
def fungsimakanan():
        ...
        if nomor==1:
            ...
            print(Fore.RED + "Pilihan tidak ada, silahkan masukan lagi!!")
            fungsimakanan()
...
print(Fore.MAGENTA + "Kembalian :", kembalian)

print("\n==================================")
print(Back.CYAN + Fore.WHITE + "====== S T R U K   B E L I =======")
print("==================================")
print (Fore.YELLOW + "Nama\t\t: " + pembeli)
print ("Beli\t\t:", porsi, mkn, "( Rp", totalmkn, ")")
print ("\t\t ", gelas, mnm, "( Rp", totalmnm, ")")
print (Fore.CYAN + "Tagihan\t\t: Rp", totalsemua)
print (Fore.MAGENTA + "Dibayar\t\t: Rp", uang)
print (Fore.GREEN + "Kembalian\t: Rp", kembalian)
